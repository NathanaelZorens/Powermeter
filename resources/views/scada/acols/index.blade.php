            ...
            <table class="gap-2 border-2 border-white border-solid border-spacing-2 mx-auto">
                ...
                <tr class="border-2 h-2 even:bg-gray-900 odd:bg-gray-800 text-lg" id="tblRow">
                    ...
                    <td class="w-32 m-auto justify-center">
                        <div class="flex">
                            <div class="bg-yellow-600 hover:bg-yellow-300  m-2 px-2 text-sm flex rounded border-solid border border-white">
                                <a href="{{ route('det',[ 'detail' => $acol->id ]) }}" class="m-auto">
                            ...
                            <button class="bg-green-700 hover:bg-green-300 m-2 px-2 text-sm flex rounded border-solid border border-white " onclick="showSideED('{{$acol->id}}')">
                            ...
                            <form action="/acols/{{$acol->id}}" method="post">
                                @method('delete')
                                @csrf
                                <button class="bg-red-600 hover:bg-red-300 m-2 px-2 text-sm flex rounded border-solid border border-white" type="submit" onclick="return confirmDelete()">
