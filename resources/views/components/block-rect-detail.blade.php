            ...
            <div class="py-3 md:py-10 mx-auto my-3 w-full md:w-64 mt-24 md:mt-52 border-2 border-solid md:border-dashed border-white" id="detailBox">
                ...
                <div class="m-3 p-2">
                    ...
                    <div class="flex flex-col w-32 ">
                        <div>
                            <button class="bg-green-700 hover:bg-green-300 m-2 px-2 text-sm w-full flex rounded border-solid border border-white" onclick="showSideED()">
                        ...
                        <div>
                            <form action="/anodes/{{$n}}" method="post" id="deleteBtn">
                                ...
                                <button class="bg-red-600 hover:bg-red-300 m-2 px-2 text-sm w-full flex rounded border-solid border border-white" onclick="return confirmDelete()">
                                    <div class="mr-auto flex">
                        ...
                        <div>
                            <button class="bg-indigo-600 hover:bg-indigo-300 m-2 px-2 text-sm w-full flex rounded border-solid border border-white" onclick="showSideAdd('{{$name}}')">
                                <div class="mr-auto flex">
